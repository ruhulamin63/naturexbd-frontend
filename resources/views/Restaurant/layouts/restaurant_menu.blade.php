   ...
   @foreach($category_all as $category)
      <div class="col-c">
         <div class="my-2 px-2 py-3 c-it bg-white shadow-sm rounded text-center ">
            <a href="{{ URL::to('/restaurant_product_category/'.$category->id) }}">
                  @if($category->image)
                     <?php if (file_exists("../../naturexbd-manage/public".$category->image)){ ?>
                        <img src="{{asset('https://manage.naturexbd.com'.$category->image)}}" class="img-fluid px-2 mx-auto">
                     <?php } else{ ?>
