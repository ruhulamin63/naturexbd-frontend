               ...
               <div class="col-lg-8 p-4 bg-white rounded shadow-sm">
                  <div class="osahan-promos">
                     ...
                     <div class="pb-3">
                              ...
                              <div class="row align-items-center">
                                 <div class="col-9">
                                    <div class="d-flex align-items-center">
                                       <img class="pp-osahan-logo" src="{{asset('img/logo.svg')}}">
                        ...
                        <a href="promo_details.html"><img src="{{asset('img/promos/p1.png')}}" class="img-fluid"></a>
                        </div>
                        </div>
                        </div></a>
                     </div>
                     ...
                     <div class="pb-3">
                        ...
                        <div class="col-3 text-center">
                        <a href="promo_details.html"><img src="{{asset('img/promos/p2.png')}}" class="img-fluid"></a>
                        </div>
                        </div>
                        </div>
                        </a>
                     ...
                     <div class="pb-3">
                        ...
                        <div class="col-3 text-center">
                        <a href="promo_details.html"><img src="{{asset('img/promos/p3.png')}}" class="img-fluid"></a>
                        </div>
                        </div>
                        </div>
                        </a>
