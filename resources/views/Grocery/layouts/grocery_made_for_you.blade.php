               ...
               <a href="{{ URL::to('/grocery_product_details/'.base64_encode($feature_product->id)) }}" class="text-dark">
                  ...
                  <div class="p-3" style="height:100%;">
                     <div style="height:80%;">
                        ...
                        <?php if (file_exists("../../naturexbd-manage/public".$feature_product->product_thumbnail)){ ?>
                           <img style=" object-fit: contain;" src="{{asset('https://manage.naturexbd.com'.$feature_product->product_thumbnail)}}" class="img-fluid product_custom_image item-img w-100 mb-3" alt="">
                        <?php } else{ ?>
