                  ...
                  <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                     <div class="card-body p-0 border-top">
                        <div class="osahan-cart">
                           <table id="cart_table" style="width: 100%;">
                              ...
                              <tr class="{{$info->product_id.'row'}}" style='width: 100%;border-bottom: 2px solid #9e9e9e45;'>
                                 ...
                                 <td style='width: 30%; text-align: center;'>
                                    @if($info->product_img)
                                    <?php if (file_exists("../public" . $info->product_img)) { ?>
                                       <img height='80px' src="{{asset(''.$info->product_img)}}">
                                    <?php } else { ?>
                           ...
                           <div>
                              <div class="rounded shadow  bg-success align-items-center p-3 text-white">
                                 <div class="more">
