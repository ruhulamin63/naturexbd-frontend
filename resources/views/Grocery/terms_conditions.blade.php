            ...
            <div class="row">
               ...
               <div class="col-lg-8 p-4 bg-white rounded shadow-sm">
                  ...
                  <div class="help_support">
                     <div class="mb-1">
                        <a href="terms&conditions.html" class="text-decoration-none"><button class="p-3 btn-light border d-flex align-items-center btn w-100" type="button">
                        Terms & Conditions 
                        <i class="text-success icofont-rounded-right ml-auto"></i>
                        </button></a>
                     </div>
                     <div class="mb-1">
                        <a href="privacy.html" class="text-decoration-none"><button class="p-3 btn-light border d-flex align-items-center btn w-100" type="button">
                        Privacy 
                        <i class="text-success icofont-rounded-right ml-auto"></i>
                        </button></a>
                     </div>
                     <div class="mb-1">
                        <a href="faq.html" class="text-decoration-none"><button class="p-3 btn-light border d-flex align-items-center btn w-100" type="button">
                        FAQ 
                        <i class="text-success icofont-rounded-right ml-auto"></i>
                        </button></a>
                     </div>
