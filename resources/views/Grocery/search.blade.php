            ...
            <div class="row">
               <div class="col-lg-12">
                  <a href="listing.html" class="text-dark">
                     <div class="d-flex align-items-center bg-white shadow-sm rounded mb-2 p-3">
                        <img src="{{asset('img/search/s1.jpg')}}" class="img-fluid rounded shadow-sm mr-3">
                  ...
                  <a href="listing.html" class="text-dark">
                     <div class="d-flex align-items-center bg-white shadow-sm rounded mb-2 p-3">
                        <img src="{{asset('img/search/s2.jpg')}}" class="img-fluid rounded shadow-sm mr-3">
                        <span class="font-weight-bold">
                           Japan Red Apple
                  ...
                  <a href="listing.html" class="text-dark">
                     <div class="d-flex align-items-center bg-white shadow-sm rounded mb-2 p-3">
                        <img src="{{asset('img/search/s3.jpg')}}" class="img-fluid rounded shadow-sm mr-3">
                        <span class="font-weight-bold">
                           Fresh Orange
                  ...
                  <a href="listing.html" class="text-dark">
                     <div class="d-flex align-items-center bg-white shadow-sm rounded mb-2 p-3">
                        <img src="{{asset('img/search/s4.jpg')}}" class="img-fluid rounded shadow-sm mr-3">
                        <span class="font-weight-bold">
                           Fresh Tomato
