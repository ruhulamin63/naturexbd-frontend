                  ...
                  <div class="osahan-vegan">
                     ...
                     <div class="fresh-vegan pb-2">
                              ...
                              <div class="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm">
                                 <div class="list-card-osahan-2 p-3">
                                    ...
                                    <a href="product_details.html" class="text-decoration-none text-dark">
                                       <img src="{{asset('img/green/g1.jpg')}}" class="img">
                           ...
                           <div class="osahan-slider-item m-2">
                              <div class="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm">
                                 <div class="list-card-osahan-2 p-3">
                                    ...
                                    <a href="product_details.html" class="text-decoration-none text-dark">
                                       <img src="{{asset('img/green/g2.jpg')}}" class="img">
                           ...
                           <div class="osahan-slider-item m-2">
                              <div class="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm">
                                 <div class="list-card-osahan-2 p-3">
                                    ...
                                    <a href="product_details.html" class="text-decoration-none text-dark">
                                       <img src="{{asset('img/green/g3.jpg')}}" class="img">
                           ...
                           <div class="osahan-slider-item m-2">
                              <div class="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm">
                                 <div class="list-card-osahan-2 p-3">
                                    <div class="member-plan position-absolute"><span class="badge badge-success">10%</span></div>
                                    <a href="product_details.html" class="text-decoration-none text-dark">
                                       <img src="{{asset('img/green/g4.jpg')}}" class="img">
                        ...
                        <div class="d-flex align-items-center mt-4 mb-2">
                           <h5 class="m-0">Daily Needs Vegan</h5>
                           <a href="listing.html" class="ml-auto text-success">See more</a>
                        </div>
                        <div class="trending-slider">
                           <div class="osahan-slider-item m-2">
                           ...
                           <div class="osahan-slider-item m-2">
                              <div class="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm">
                                 <div class="list-card-osahan-2 p-3">
                                    <div class="member-plan position-absolute"><span class="badge badge-dark">10%</span></div>
                                    <a href="product_details.html" class="text-decoration-none text-dark">
                                       <img src="{{asset('img/green/g5.jpg')}}" class="img">
                           ...
                           <div class="osahan-slider-item m-2">
                              <div class="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm">
                                 <div class="list-card-osahan-2 p-3">
                                    <div class="member-plan position-absolute"><span class="badge badge-dark">10%</span></div>
                                    <a href="product_details.html" class="text-decoration-none text-dark">
                                       <img src="{{asset('img/green/g6.jpg')}}" class="img">
                           ...
                           <div class="osahan-slider-item m-2">
                              <div class="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm">
                                 <div class="list-card-osahan-2 p-3">
                                    <div class="member-plan position-absolute"><span class="badge badge-dark">10%</span></div>
                                    <a href="product_details.html" class="text-decoration-none text-dark">
                                       <img src="{{asset('img/green/g7.jpg')}}" class="img">
                           ...
                           <div class="osahan-slider-item m-2">
                              <div class="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm">
                                 <div class="list-card-osahan-2 p-3">
                                    <div class="member-plan position-absolute"><span class="badge badge-dark">10%</span></div>
                                    <a href="product_details.html" class="text-decoration-none text-dark">
                                       <img src="{{asset('img/green/g8.jpg')}}" class="img">
                           ...
                           <div class="osahan-slider-item m-2">
                              <div class="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm">
                                 <div class="list-card-osahan-2 p-3">
                                    <div class="member-plan position-absolute"><span class="badge badge-dark">10%</span></div>
                                    <a href="product_details.html" class="text-decoration-none text-dark">
                                       <img src="{{asset('img/green/g9.jpg')}}" class="img">
