                              ...
                              <div class="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm">
                                 <div class="recommend-slider rounded m-0">
                                    <div class="osahan-slider-item m-2 rounded">
                                       <img src="{{asset('img/recommend/r1.jpg')}}" class="img-fluid mx-auto rounded shadow-sm" alt="Responsive image">
                                    </div>
                                    <div class="osahan-slider-item m-2 rounded">
                                       <img src="{{asset('img/recommend/r2.jpg')}}" class="img-fluid mx-auto rounded shadow-sm" alt="Responsive image">
                                    </div>
                                    <div class="osahan-slider-item m-2 rounded">
                                       <img src="{{asset('img/recommend/r3.jpg')}}" class="img-fluid mx-auto rounded shadow-sm" alt="Responsive image">
                                    </div>
                                 </div>
                              ...
                              <div class="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm">
                                 <div class="recommend-slider rounded m-0">
                                    <div class="osahan-slider-item m-2">
                                       <img src="{{asset('img/recommend/r4.jpg')}}" class="img-fluid mx-auto rounded shadow-sm" alt="Responsive image">
                                    </div>
                                    <div class="osahan-slider-item m-2">
                                       <img src="{{asset('img/recommend/r5.jpg')}}" class="img-fluid mx-auto rounded shadow-sm" alt="Responsive image">
                                    </div>
                                    <div class="osahan-slider-item m-2">
                                       <img src="{{asset('img/recommend/r6.jpg')}}" class="img-fluid mx-auto rounded shadow-sm" alt="Responsive image">
                                    </div>
                                 </div>
                                 <div class="p-3 position-relative">
                        ...
                        <div class="col-12 col-md-4 mb-3">
                           <a href="product_details.html" class="text-dark text-decoration-none">
                              <div class="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm">
                                 <div class="recommend-slider rounded m-0">
                                    <div class="osahan-slider-item m-2">
                                       <img src="{{asset('img/recommend/r7.jpg')}}" class="img-fluid mx-auto rounded shadow-sm" alt="Responsive image">
                                    </div>
                                    <div class="osahan-slider-item m-2">
                                       <img src="{{asset('img/recommend/r8.jpg')}}" class="img-fluid mx-auto rounded shadow-sm" alt="Responsive image">
                                    </div>
                                    <div class="osahan-slider-item m-2">
                                       <img src="{{asset('img/recommend/r9.jpg')}}" class="img-fluid mx-auto rounded shadow-sm" alt="Responsive image">
                                    </div>
                                 </div>
                                 <div class="p-3 position-relative">
