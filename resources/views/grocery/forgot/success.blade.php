               ...
               <div class="col-lg-4 pl-lg-5">
                  <div class="osahan-signin shadow-sm bg-white p-4 rounded">
                     <div class="p-3 text-center">
                        <h4 style="color:#8DC63F">Password reset successful !</h4>
                        <h6><strong>Please check your mail including new Password. </strong></h5>
                        <br>
                        <br>
                        <br>
                        <p class="small mb-4">We sent you a success mail including your new password.Please check your email and login using your new password!!</p>
