                           ...
                           <div class="col-lg-12">
                              <div class="osahan-status">
                                 ...
                                 <div class="p-3 status-order bg-white border-bottom d-flex align-items-center">
                                    ...
                                    <a href="review.html" class="text-success ml-auto text-decoration-none">Review</a>
                                 </div>
                                 ...
                                 <div class="p-3 border-bottom">
                                    ...
                                    <img src="{{asset('img/logo.svg')}}" class="img-fluid sc-osahan-logo mr-2"> <span class="small text-success font-weight-bold">Grocery Courier
                                    </span>
                                 </div>
                                 <!-- total price -->
                                 <!-- Destination -->
