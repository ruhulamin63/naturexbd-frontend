         ...
         <div class="container">
            <div class="row">
               ...
               <div class="col-lg-8 p-4 bg-white rounded shadow-sm">
                  <h4 class="mb-4 profile-title">FAQ - Basics</h4>
                  <div id="basics">
                     <!-- Basics Accordion -->
                     <div id="basicsAccordion">
                        ...
                        <div class="box border rounded mb-1 bg-white">
                           <div id="basicsHeadingOne">
                              <h5 class="mb-0">
                                 <button class="shadow-none btn btn-block d-flex align-items-center justify-content-between card-btn p-3 collapsed" data-toggle="collapse" data-target="#basicsCollapseOne" aria-expanded="false" aria-controls="basicsCollapseOne">
                                 Do you have any built-in caching? <i class="icofont-simple-down"></i>
                                 </button>
                              </h5>
                           </div>
                        ...
                        <div class="box border rounded mb-1 bg-white">
                           <div id="basicsHeadingTwo">
                              <h5 class="mb-0">
                                 <button class="shadow-none btn btn-block d-flex align-items-center justify-content-between card-btn p-3 collapsed" data-toggle="collapse" data-target="#basicsCollapseTwo" aria-expanded="false" aria-controls="basicsCollapseTwo">
                                 Can I add/upgrade my plan at any time? <i class="icofont-simple-down"></i>
                                 </button>
                              </h5>
                           </div>
                        ...
                        <div class="box border rounded mb-1 bg-white">
                           <div id="basicsHeadingThree">
                              <h5 class="mb-0">
                                 <button class="shadow-none btn btn-block d-flex align-items-center justify-content-between card-btn p-3 collapsed" data-toggle="collapse" data-target="#basicsCollapseThree" aria-expanded="false" aria-controls="basicsCollapseThree">
                                 What access comes with hosting plan? <i class="icofont-simple-down"></i>
                                 </button>
                              </h5>
                           </div>
                        ...
                        <!-- End Card -->
                        <!-- Card -->
                        <div class="box border rounded mb-1 mb-2 bg-white">
                           <div id="basicsHeadingFour">
                              <h5 class="mb-0">
                                 <button class="shadow-none btn btn-block d-flex align-items-center justify-content-between card-btn collapsed p-3" data-toggle="collapse" data-target="#basicsCollapseFour" aria-expanded="false" aria-controls="basicsCollapseFour">
                                 How do I change my password? <i class="icofont-simple-down"></i>
                                 </button>
                              </h5>
                           </div>
