         ...
         <div class="container">
            <div class="row">
               ...
               <div class="col-lg-8 p-4 bg-white rounded shadow-sm">
                  <h4 class="mb-4 profile-title">Tickets</h4>
                  <div id="edit_profile">
                     <div class="p-0">
                        <form action="help_ticket.html">
                           <div class="form-group">
                              <label for="exampleInputName1">Full Name</label>
                              <input type="text" placeholder="Enter Full Name" class="form-control" id="exampleInputName1">
                           </div>
                           <div class="form-group">
                           ...
                           <div class="form-group">
                              ...
                              <input type="text" placeholder="can we improve?" class="form-control" id="exampleInputHelp1">
                           </div>
                           <button type="submit" class="btn btn-success btn-lg btn-block">Ask us freely</button>
                        </form>
                     </div>
                  </div>
               </div>
