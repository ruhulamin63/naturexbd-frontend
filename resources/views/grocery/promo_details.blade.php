               ...
               <div class="col-md-3">
                  <div class="bg-success rounded shadow-sm text-center p-2">
                     <div class="bg-white rounded shadow-sm p-4 mb-3">
                        <img src="{{asset('img/promos/p1.png')}}" class="img-fluid">
                     </div>
                     <img class="p-osahan-logo" src="{{asset('img/logo.svg')}}">
                     <h5 class="mt-2 mb-1 text-white">Grocery</h5>
                     <div class="pt-3">
                        <p class="btn btn-warning btn-lg btn-block mb-0"><i class="icofont-tag mr-1"></i> OSAHAN50 OFF</p>
                     </div>
                  </div>
               </div>
               <div class="col-md-9">
                  <div class="osahan-promo overflow-hidden rounded shadow-sm bg-white">
                     <div class="promo_detail">
                        <div class="title p-3 bg-white shadow-sm d-flex align-items-center">
                           <div class="title">
                              <h5 class="font-weight-bold text-success">Get 25% off buying Banana</h5>
                              <p class="small text-muted m-0">Available until 24 July 2020</p>
                           </div>
                           <div class="ml-auto">
                              <a href="product_details.html" class="btn btn-lg btn-danger bg-danger px-5 border-0">Buy Now</a>
                           </div>
                        </div>
                        <div class="p-3 bg-light">
                           <p class="font-weight-bold mb-2">Highlights</p>
                           <p class="small m-0">Enjoy free delivery every buy long bread, only at New York. Thank You for choosing Grocery 😊</p>
                        </div>
                        <div class="p-3">
                           <p class="font-weight-bold mb-2">Terms $ Conditions</p>
                           <ul class="pl-3 mb-0">
                              <li class="text-muted">Easypromos only uses detials of its users to facilitate the successful operation of the promotions.<br>Easypromos will never utilize detials of registered users for any other reason.
                              </li>
                              <li class="text-muted">Easypromos cannot be held responsible for the prizes, products or services offered to useres thorugh the promotions.</li>
                              <li class="text-muted">Easypromos cannot be held responsible for the prizes, products or services offered to useres thorugh the promotions.</li>
                              <li class="text-muted">Easypromos only uses detials of its users to facilitate the successful operation of the promotions.<br>Easypromos will never utilize detials of registered users for any other reason.
                              </li>
                              <li class="text-muted">Easypromos cannot be held responsible for the prizes, products or services offered to useres thorugh the promotions.</li>
