      ...
      <div class="col-6 col-sm-4 col-md-4 col-lg-4 col-xl-3 mb-3">
         <div class="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm">
            <div class="list-card-image" style="height:100%;">
               <a href="{{ URL::to('/grocery_product_details/'.base64_encode($made_product->id)) }}" class="text-dark">
                  <div class="member-plan position-absolute"><!--<span class="badge m-3 badge-danger">10%</span>--></div>
                  <div class="p-3" style="height:100%;">
                     <div style="height:80%;">
                        @if($made_product->product_thumbnail)
                        <?php if (file_exists("../../naturexbd-manage/public".$made_product->product_thumbnail)){ ?>
                           <img style=" object-fit: contain;" src="{{asset('https://manage.naturexbd.com'.$made_product->product_thumbnail)}}" class="img-fluid product_custom_image item-img w-100 mb-3" alt="">
                        <?php } else{ ?>
                        ...
                        @else
                           <img style=" object-fit: contain;" src="{{asset('/B0eS.gif')}}" class="img-fluid product_custom_image item-img w-100 mb-3" alt="">
                        @endif
                        <h6>{{$made_product->product_name}}</h6>
                     </div>
                     <h6>&nbsp</h6>
                     <h6 class="price m-0 text-success">{{$made_product->measuring_unit_new}}</h6>
                     <div class="d-flex align-items-center">
                        <h6 class="price m-0 text-success">BDT {{$made_product->product_price}}</h6>
