      ...
      <nav aria-label="breadcrumb" class="breadcrumb mb-0">
         <div class="container">
            <ol class="d-flex align-items-center mb-0 p-0">
               ...
               <li class="breadcrumb-item active" aria-current="page">{{isset($products[0])?$products[0]->category:''}}</li>
            </ol>
         </div>
      </nav>
      <!-- body -->
                                    ...
                                    <div class="list-card-image" style="height:100%;">
                                       <a href="{{ URL::to('/grocery_product_details/'.base64_encode($product->id)) }}" class="text-dark">
                                          ...
                                          <div class="p-3" style="height:100%;">
                                             ...
                                             <h6>&nbsp</h6>
                                             <h6 class="price m-0 text-success">{{$product->measuring_unit_new}} gm</h6>
