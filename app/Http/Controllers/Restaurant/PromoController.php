...
{
    public function restaurant_promo_details(Request $request,$id)
    {
        $ip = $this->getIp();
        ...
        $promo_info=DB::table('restaurant_promo')->where('id',$promo_id)->where('status',1)->where('activeSatus',1)->first();
